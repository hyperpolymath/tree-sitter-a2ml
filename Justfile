...
doctor:
    @echo "Running diagnostics for tree-sitter-a2ml..."
...
help-me:
    @echo "=== tree-sitter-a2ml Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/tree-sitter-a2ml/issues/new"
    @echo ""
