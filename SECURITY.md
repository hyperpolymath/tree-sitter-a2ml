...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/tree-sitter-a2ml/security/advisories/new)
...
- This repository (`hyperpolymath/tree-sitter-a2ml`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/tree-sitter-a2ml/security/advisories)
...
When using Tree Sitter A2ml, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/tree-sitter-a2ml/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/tree-sitter-a2ml/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/tree-sitter-a2ml/discussions) |
...
*Thank you for helping keep Tree Sitter A2ml and its users safe.* 🛡️
