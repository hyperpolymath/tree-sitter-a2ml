...
// Replace tree-sitter-a2ml, Tree Sitter A2Ml — See README.adoc for details., just run, Tree Sitter A2Ml started successfully. with actuals
= tree-sitter-a2ml — Quick Start for Users
:toc:
:toclevels: 2

== What is tree-sitter-a2ml?

Tree Sitter A2Ml — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./tree-sitter-a2ml-portable
----
...
[source]
----
Tree Sitter A2Ml started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/tree-sitter-a2ml/wiki
