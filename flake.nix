{
  description = "tree-sitter-a2ml - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 tree-sitter-a2ml development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P tree-sitter-a2ml.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/tree-sitter-a2ml $out/bin/  # Rust
            # cp bin/tree-sitter-a2ml $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/tree-sitter-a2ml";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-tree-sitter-a2ml" {
