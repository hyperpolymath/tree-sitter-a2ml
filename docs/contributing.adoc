...
= Contributing — tree-sitter-a2ml
:revdate: 2026-MM-DD

== Audience

Developers working *on* `tree-sitter-a2ml`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/tree-sitter-a2ml.git
cd tree-sitter-a2ml
...
* Bugs in `tree-sitter-a2ml`: file at `hyperpolymath/tree-sitter-a2ml/issues`.
